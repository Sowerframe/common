...
class Auth
{
    ...
    public function register($username, $password, $email = '', $mobile = '', $extend = [])
    {
        ...
        try {
            ...
            $this->_user = User::where('id',$user->id)->find();
    ...
    public function direct($user_id)
    {
        ...
        if ($user) {
            ...
            try {
                ...
                //判断连续登录和最大连续登录
                if ($user->logintime < \sums\Date::unixtime('day')) {
                    $user->successions = $user->logintime < \sums\Date::unixtime('day', -1) ? 1 : $user->successions + 1;
